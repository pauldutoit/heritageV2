...
?>
	...
	<p class="description">
		...
		<?php echo esc_html__('This setting is available only for the following menu styles: [Classic Doubled Menu]', 'artemis-swp'); ?>
	</p>	
<?php
...
?>
	<select id="lc_back_to_top" name="artemis_theme_general_options[lc_back_to_top]">
		<?php ARTEMIS_SWP_render_select_options($sticky_options, $back_to_top); ?>
	</select>
	<p class="description">
