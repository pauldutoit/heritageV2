			...
			<div class="at_login account_option">
                <?php if ( is_user_logged_in() ) { ?>
                    <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>"
                       title="<?php esc_html_e( 'My Account', 'artemis-swp' ); ?>"><?php esc_html_e( 'My Account', 'artemis-swp' ); ?></a>
                <?php } else { ?>
                    <a href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>"
                       class="<?php echo esc_attr( ARTEMIS_SWP_is_login_popup_enabled() ? 'at_to_login_popup' : '' ) ?>"
                       title="<?php esc_html_e( 'Login / Register', 'artemis-swp' ); ?>"><?php esc_html_e( 'Login / Register', 'artemis-swp' ); ?></a>
                <?php } ?>
			</div>
            <?php } ?>
		</div>
