                        ...
                        <form name="loginform" id="at_loginform" method="post">
                            ...
                            <p class="login-username">
                                <input type="text" name="username" class="input"
                                       placeholder="<?php echo esc_attr('Enter your username or email', 'artemis-swp'); ?>"/>
                            </p>
                            <p class="login-password">
                                <input type="password" name="password" class="input" placeholder="<?php echo esc_attr('Password', 'artemis-swp'); ?>"/>
                            </p>
