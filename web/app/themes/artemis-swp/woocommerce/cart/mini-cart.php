...
<ul class="cart_list product_list_widget <?php echo esc_attr($args['list_class']); ?>">
	...
	<?php else : ?>
        ...
        <li class="empty"><?php esc_html_e( 'No products in the cart.', 'artemis-swp' ); ?></li>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
    <p class="total"><strong><?php esc_html_e( 'Subtotal', 'artemis-swp' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
    ...
    <p class="buttons">
		...
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'artemis-swp' ); ?></a>
	</p>
