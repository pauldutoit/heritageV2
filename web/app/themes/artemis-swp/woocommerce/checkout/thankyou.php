...
<div class="woocommerce-order">
	...
	<?php else : ?>
        <p class="woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'artemis-swp' ), null ); ?></p>
	<?php endif; ?>
</div>
