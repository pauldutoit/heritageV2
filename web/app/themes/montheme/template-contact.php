...
$contact_address = HERITAGE_get_contact_address();
$contact_email = HERITAGE_get_contact_email();
$contact_phone = HERITAGE_get_contact_phone();
$contact_fax = HERITAGE_get_contact_fax();

$allowed_tags = array(
    'strong' => array()
);

$visit_us_msg = wp_kses(__("Visit <strong>Us</strong>", "heritage"), $allowed_tags);
$call_us_msg = wp_kses(__("Call <strong>Us</strong>", "heritage"), $allowed_tags);
