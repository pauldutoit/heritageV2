...
class HERITAGE_Customize {
    ...
    public static function register_controls() {
        wp_enqueue_script( 'heritage_customizer_controls',
            get_template_directory_uri() . '/customizer/js/customizer_controls.js',
            array( 'jquery' ),
            '1.0.0',
            true );
        wp_localize_script( 'heritage_customizer_controls', 'heritageCustomizerControlsConfig', get_option( 'lc_customize', array() ) );
    }
    ...
    public static function header_output()
    {
        ...
        <style type="text/css">
            ...
            .at_swp_single_grid_prod .amount
            ...
            .heritage-minicart-icon .heritage-minicart .buttons .button.checkout:hover,
            .heritage-minicart-icon .heritage-minicart .buttons .button, .brick_cust_link a.at_link_line_before:hover:before,
            ...
            .heritage-minicart-icon .heritage-minicart .buttons .button
            ...
            .heritage-minicart-icon .heritage-minicart
            { background-color: <?php echo esc_html($lc_customize['lc_minicart_wishlist_popup_bg_color']); ?>; }

            <?php /*order summary bg color*/ ?>
            .heritage-order-thank-you .heritage-order-summary, .woocommerce-checkout-review-order, .cart_totals table,
            ...
            .heritage-minicart-icon .heritage-minicart .buttons .button:hover,
            .heritage-minicart-icon .heritage-minicart .buttons .button.checkout:hover,
...
function HERITAGE_sanitize_buttons_custom($value) {
