...
$button_text = esc_html__("Read more", "heritage");
$post_type = get_post_type();
switch($post_type) {
    case "js_videos":
        $taxonomy_type = "video_category";
        $button_text = esc_html__("Watch video", "heritage");
        break;
    case "js_photo_albums":
        $taxonomy_type = "photo_album_category";
        $button_text = esc_html__("View gallery", "heritage");
        break;
    default:
        break;
}
