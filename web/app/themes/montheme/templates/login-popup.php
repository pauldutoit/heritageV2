                ...
                <div class="at_login_popup_forms">
                    ...
                    <div id="at_login_form_container" class="active">
                        ...
                        <form name="loginform" id="at_loginform" method="post">
                            ...
                            <?php
                            //add_filter('login_form_middle', 'heritage_SWP_add_lost_password_link'); // ajouter le liens "Mot de passe oublié ?"
                            ...
                            <p class="login-submit">
                                ...
                                <?php wp_nonce_field('heritage_swp-login', 'heritage-swp-login-nonce'); ?> <?php /* aucune idée de ce que ça fait */ ?>
