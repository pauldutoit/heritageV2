...
if (!empty($copyrigth_text)) {
    ?> <div class="lc_copy_area clearfix lc_swp_bg_color <?php echo esc_attr($copy_cs).' '.esc_attr($header_width); ?>" data-color="<?php echo esc_attr($copy_bgc); ?>"> <?php
        ...
        if (HERITAGE_have_social_on_copyright() && !empty($user_profiles)) {
            ?>
            <div class="one_of_two text_left">
                <a class="transition4" href="<?php echo esc_url(HERITAGE_get_copyrigth_url()); ?>"><?php echo esc_html($copyrigth_text); ?></a>
            </div>
            ...
            ?> <a class="transition4" href="<?php echo esc_url(HERITAGE_get_copyrigth_url()); ?>"><?php echo esc_html($copyrigth_text); ?></a> <?php
        }
